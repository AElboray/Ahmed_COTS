...
/*required: All row pins are input pulled up, all column pins output high*/
u8 KPD_u8GetPressedKey(void)
{
	u8 Local_u8PressedKey = KPD_u8NO_PRESSED_KEY_VAL;
	u8 Local_u8RowCounter, Local_u8ColCounter, Local_u8KeyState;
	...
	static u8 Local_u8KPDArr[KPD_u8ROW_NUM][KPD_u8COL_NUM] = KPD_u8BUTTON_ARR;
